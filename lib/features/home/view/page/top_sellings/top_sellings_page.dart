...
class TopSellingsPage extends StatefulWidget {
  const TopSellingsPage({super.key});

  @override
  State<TopSellingsPage> createState() => _TopSellingsPageState();
}

class _TopSellingsPageState extends State<TopSellingsPage> {
  List<Map>? topSelling;
  String localhost =
  ...
  void initState() {
    ...
    if (mounted) {
      setState(() {
        ...
        likes = topSelling!.map((e) => e['isLiked']).toList();
      });
    }
  }
